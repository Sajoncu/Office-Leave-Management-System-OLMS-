...
<?php
	...
	//Checking Errors
		...
		print '<p class="btn btn-danger btn-large Registration_Warning"> Sorry, student is not added successfully. Please fulfil the following  requirements : </p>';
		...
		if(count($Errors)==0){
			...
			$n=count($Errors);
			print'<div class="container"> <div class="row"> <div class="col-md-6 col-md-offset-3">';
			print '<p class="btn btn-success btn-large Registration_Warning"> Congratulations, student has been successfully added with following info : </p>';
			print'<ul class="list-group">';	
